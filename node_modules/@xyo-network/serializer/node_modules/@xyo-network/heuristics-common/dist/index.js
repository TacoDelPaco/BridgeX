...
class XyoUnixTime extends serialization_1.XyoBaseSerializable {
    ...
    getData() {
        return buffer_utils_1.writeIntegerToBuffer(this.date.valueOf(), 8, false);
    }
    getReadableValue() {
...
class XyoUnixTimeDeserializer {
    ...
    deserialize(data, serializationService) {
        ...
        const resultingNumber = buffer_utils_1.readIntegerFromBuffer(parseResult.dataBytes, 8, false);
