...
export declare type pureFn<V> = () => V;
export declare type asyncPureFn<V> = () => Promise<V>;
export declare type providerFn<V> = () => Promise<V>;
export declare type parameterizedProviderFn<C, V> = (context: C) => Promise<V>;
export declare type factoryFn<V> = () => V;
export declare type parameterizedFactoryFn<C, V> = (context: C) => V;
...
export declare type depScope = 'transient' | 'singleton';
