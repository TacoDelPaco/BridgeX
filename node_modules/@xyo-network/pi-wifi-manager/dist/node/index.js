...
class NodeWifiManager extends utils_1.Subscribe {
    constructor() {
        ...
        this.logger = (0, debug_1.default)('wifi:node');
        ...
        this.updateStatus = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.logger('status update error', e);
            }
        });
        this.wifi.init({
            iface: null
    ...
    getStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ssid = (0, lodash_1.first)(connections) || '';
            const ip = (0, utils_2.getIp)() || '';
            return {
                ssid,
                ip
            };
