...
export {
  Callback, IFactory, IInitializable,
  ILifeCyclable, ILifeCycleEvent, IParameterizedFactory,
  IParameterizedProvider,
  IProvider, IRepoItem, IRunnable, IXyoProvider,
  IXyoProviderContainer, IXyoRepository,
  asyncPureFn, depScope, factoryFn, parameterizedFactoryFn,
  parameterizedProviderFn,
  providerFn,
  pureFn, unsubscribeFn
} from './@types'
...
export class BaseLifeCyclable extends XyoBase implements ILifeCyclable {
  ...
  public once(event: string, listener: (...args: unknown[]) => void) {
