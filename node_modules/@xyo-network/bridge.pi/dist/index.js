...
const hasher = hashing_1.getHashingProvider('sha256');
...
const startPi = () => __awaiter(this, void 0, void 0, function* () {
...
const waitForMutexToBeFinished = () => __awaiter(this, void 0, void 0, function* () {
...
const waitForWifi = () => __awaiter(this, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        let interval;
...
const startBridge = (service) => __awaiter(this, void 0, void 0, function* () {
...
const waitForBleno = () => {
    bleno_1.default.enable();
    return new Promise((resolve, reject) => {
        bleno_1.default.on('stateChange', (newState) => __awaiter(this, void 0, void 0, function* () {
