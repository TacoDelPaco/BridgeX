...
import { IBridgeConfigurationManager } from '@xyo-network/bridge-configuration';
...
export declare class XyoBridgeConfigurationEndpoint implements IBridgeConfigurationManager {
    ...
    setDefaultArchivist: (id: string) => Promise<import("@xyo-network/bridge-configuration").IArchivist>;
    getDefaultArchivist: () => Promise<import("@xyo-network/bridge-configuration").IArchivist>;
    getAttachedArchivists: () => Promise<import("@xyo-network/bridge-configuration").IArchivist[]>;
    attachArchivist: (dns: string, port: number) => Promise<import("@xyo-network/bridge-configuration").IArchivist>;
    detachArchivist: (id: string) => Promise<import("@xyo-network/bridge-configuration").IArchivist>;
