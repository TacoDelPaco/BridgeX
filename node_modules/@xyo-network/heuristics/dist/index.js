...
exports.getDoubleSerializer = exports.getFloatSerializer = exports.getSignedIntegerSerializer = exports.getUnsignedIntegerSerializer = exports.XyoNumberDeserializer = exports.XyoSerializableNumber = void 0;
...
class XyoSerializableNumber extends serialization_1.XyoBaseSerializable {
    ...
    getData() {
        if (this.numberType === 'unsigned-integer') {
            return (0, buffer_utils_1.unsignedIntegerToBuffer)(this.number);
        }
        if (this.numberType === 'signed-integer') {
            return (0, buffer_utils_1.signedIntegerToBuffer)(this.number);
        }
        if (this.numberType === 'float') {
            return (0, buffer_utils_1.floatToBuffer)(this.number);
        }
        if (this.numberType === 'double') {
            return (0, buffer_utils_1.doubleToBuffer)(this.number);
        }
...
class XyoNumberDeserializer {
    ...
    deserialize(data, serializationService) {
        ...
        let number;
        if (this.numberType === 'unsigned-integer') {
            number = (0, buffer_utils_1.readIntegerFromBuffer)(parseResult.dataBytes, parseResult.dataBytes.length, false, 0);
        }
        else if (this.numberType === 'signed-integer') {
            number = (0, buffer_utils_1.readIntegerFromBuffer)(parseResult.dataBytes, parseResult.dataBytes.length, true, 0);
        }
        else if (this.numberType === 'float') {
            number = (0, buffer_utils_1.readFloatFromBuffer)(parseResult.dataBytes, 0);
        }
        else if (this.numberType === 'double') {
            number = (0, buffer_utils_1.readDoubleFromBuffer)(parseResult.dataBytes, 0);
        }
        else {
            throw new errors_1.XyoError(`Unsupported number typed ${this.numberType || 'undefined'}`);
        }
