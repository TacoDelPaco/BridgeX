...
function parse(src, schema) {
    ...
    const data = sliceItem_1.sliceItem(src, 0, partialSchema, true);
    ...
    const items = [];
    let innerHeader = readHeader_1.readHeader(data);
    ...
    while (offset < data.length) {
        ...
        if (partialSchema.iterableType === 'iterable-untyped') {
            if (offset !== 2) {
                ...
                innerHeader = readHeader_1.readHeader(innerHeaderBytes);
                offset += 2;
            }
        }
        if (offset !== 2) {
        ...
        const bytes = sliceItem_1.sliceItem(data, offset, innerHeader, false);
