...
exports.XyoNestedBoundWitnessExtractor = void 0;
...
class XyoNestedBoundWitnessExtractor {
     ...
     * them out.
     */
    extractNestedBoundWitnesses(boundWitness) {
        const nestedBoundWitnesses = [];
     ...
     */
    recursivelyExtractNestedBoundWitnesses(boundWitness, boundWitnessContainer) {
        boundWitness.metadata.forEach((payload) => {
            payload.forEach((unsignedPayloadItem) => {
                if (unsignedPayloadItem.schemaObjectId !== serialization_schema_1.schema.bridgeBlockSet.id) {
                    return;
                }
                const nestedBridgeBlockSet = unsignedPayloadItem;
...
exports.XyoNestedBoundWitnessExtractor = XyoNestedBoundWitnessExtractor;
//# sourceMappingURL=xyo-nested-bound-witness-extractor.js.map