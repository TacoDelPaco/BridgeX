declare module "@abandonware/noble" { 
    ...
    export function on(event: string, listener: void): events.EventEmitter
    ...
    export function removeListener(event: string, listener: void): events.EventEmitter
    ...
    export class Characteristic extends events.EventEmitter {
        ...
        on(event: "notify", listener: (data: Buffer, isNotification: boolean) => void): this
        on(event: "broadcast", listener: (data: Buffer, isNotification: boolean) => void): this
        ...
        on(event: string, listener: void): this
        on(event: string, option: boolean, listener: void): this
    }
