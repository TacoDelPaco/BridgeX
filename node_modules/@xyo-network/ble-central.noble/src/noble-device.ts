...
export class NobleDevice implements IXyoBluetoothDevice {
  ...
  public discoverServicesForUuids(serviceUUIDs: string[]): IXyoService[] {
    // eslint-disable-next-line no-async-promise-executor
    ...
    try {
      ...
      this.device.discoverServices(serviceUUIDs, (_, services) => {
      ...
      throw new Error(`discoverServices(): Error`)
    }
    return returnArray
  }

  // default no async/await
  public discoverServices(): IXyoService[] {
