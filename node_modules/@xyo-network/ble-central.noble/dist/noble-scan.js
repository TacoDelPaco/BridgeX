...
class NobleScan {
    constructor() {
        ...
        this.inRangeDevices = {};
        this.cleanDevices = () => __awaiter(this, void 0, void 0, function* () {
        ...
        this.stateChange = (state) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                if (noble_1.default.state === "poweredOn") {
                    const callback = () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        noble_1.default.removeListener(`scanStart`, callback);
                        resolve();
                    });
                    this.logger.info("Trying to start scanner");
                    noble_1.default.on('scanStart', callback);
                    try {
                        yield noble_1.default.startScanningAsync([], true);
                    }
                    catch (error) {
                        reject(`startScan() error`);
                    }
                    return;
                }
    ...
    stopScan() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    yield noble_1.default.stopScanningAsync();
                }
                catch (error) {
                    reject(`stopScan() error`);
                }
                resolve();
            }));
        });
