...
class NobleScan {
    constructor() {
        ...
        this.inRangeDevices = {};
        this.callbackInfo = () => {
            this.logger.info(`callback(): ${this.callbackInfo.caller}`);
        };
        this.cleanDevices = () => {
        ...
        return new Promise((resolve, reject) => {
            if (noble_1.default.state === "poweredOn") {
                const callback = () => {
                    ...
                    noble_1.default.removeListener('scanStart', this.callbackInfo);
                    resolve();
                };
    ...
    stopScan() {
        ...
        return new Promise((resolve) => {
            ...
            noble_1.default.stopScanning(this.callbackInfo);
            noble_1.default.removeListener('scanStop', this.callbackInfo);
            resolve();
        });
    }
    getDevices() {
