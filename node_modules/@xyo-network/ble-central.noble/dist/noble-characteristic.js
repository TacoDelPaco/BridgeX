    ...
    write(value) {
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                this.characteristic.writeAsync(value, true);
                resolve();
            }
            catch (e) {
    ...
    discoverDescriptors() {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const descriptors = yield this.characteristic.discoverDescriptorsAsync();
                const returnArray = [];
                ...
                reject(`discoverDescriptorsAsync(): Error ${e}`);
            }
        }));
    }
    subscribe() {
