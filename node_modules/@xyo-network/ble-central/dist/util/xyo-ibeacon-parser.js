...
exports.getIBeacon = void 0;
function getIBeacon(ad) {
    ...
    if (manufactureData[0] === 0x4c &&
        ...
        const uuid = manufactureData.subarray(4, 20).toString('hex');
...
exports.getIBeacon = getIBeacon;
//# sourceMappingURL=xyo-ibeacon-parser.js.map