...
export interface IXyoBluetoothDevice {
  ...
  discoverServicesForUuids(serviceUUIDs: string[]): IXyoService[]
  discoverServices(): IXyoService[]
  // discoverServicesAsync(): Promise<IXyoService[]>
}
...
export interface IXyoService {
  ...
  discoverCharacteristics(): IXyoCharacteristic[]
}
