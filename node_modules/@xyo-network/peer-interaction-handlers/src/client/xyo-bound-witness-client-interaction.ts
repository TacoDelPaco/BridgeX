...
import { FetterOrWitness, IXyoBoundWitness, IXyoPayload, XyoBoundWitnessFragment, XyoFetter, XyoKeySet, XyoSignatureSet, XyoWitness } from '@xyo-network/bound-witness'
...
export class XyoBoundWitnessClientInteraction extends XyoBase implements IXyoNodeInteraction<IXyoBoundWitness> {
  ...
  public async run(networkPipe: IXyoNetworkPipe, didInit: boolean): Promise<IXyoBoundWitness> {
    ...
    return new Promise((resolve, reject) => {
      try {
        resolve(this.performInteraction(networkPipe))
      } catch (err) {
        reject(err)
      }
