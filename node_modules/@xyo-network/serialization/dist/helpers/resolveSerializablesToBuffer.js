...
exports.resolveSerializablesToBuffer = void 0;
...
function resolveSerializablesToBuffer(schema, objectSchema, serializables) {
    ...
    if (arraySerializationType === 'iterable-typed') {
        const bufferSize = (0, getNumberOfBytesRequiredForSizeBuffer_1.getNumberOfBytesRequiredForSizeBuffer)(highestByteAmount);
        const componentsWithSize = components.reduce((collection, component) => {
            const sizeBuffer = (0, getSizeHeader_1.getSizeHeader)(component.buffer.length, bufferSize);
        ...
        return Buffer.concat([
            (0, getHeader_1.getHeader)(highestByteAmount, {
                id: innerSchema.id,
    ...
    const componentsWithHeaders = components.reduce((collection, component) => {
        ...
        const componentHeader = (0, getHeader_1.getHeader)(component.buffer.length, {
            id: innerSchema.id,
