...
exports.XyoBaseSerializable = void 0;
...
class XyoBaseSerializable extends base_1.XyoBase {
    ...
    serialize() {
        ...
        const serialized = (() => {
            ...
            if (result instanceof Buffer) {
                return (0, serialize_1.serialize)(result, this.findSchemaById(this.schemaObjectId, this.schema));
            }
            if (Array.isArray(result)) {
                const serializationResult = this.serializablesToBuffer(result);
                return (0, serialize_1.serialize)(serializationResult, this.findSchemaById(this.schemaObjectId, this.schema));
            }
            return (0, serialize_1.serialize)(result.serialize(), this.findSchemaById(this.schemaObjectId, this.schema));
        })();
    ...
    readSelfSchema() {
        if (this.origin) {
            return (0, readHeader_1.readHeader)(this.origin);
        }
        return undefined;
    }
    realSchema() {
    ...
    serializablesToBuffer(serializables) {
        ...
        return (0, resolveSerializablesToBuffer_1.resolveSerializablesToBuffer)(this.findSchemaById(this.schemaObjectId, this.schema), this.schema, serializables);
    }
    findSchemaById(id, schema) {
        ...
        return (0, findSchemaById_1.findSchemaById)(id, schema);
    }
}
