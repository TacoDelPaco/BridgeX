...
import { IIterableType, IXyoObjectPartialSchema, IXyoObjectSchema, IXyoSerializableObject } from "../@types"
...
export function resolveSerializablesToBuffer(
  ...
  if (arraySerializationType === 'iterable-typed') {
    const bufferSize = getNumberOfBytesRequiredForSizeBuffer({ byteLength: highestByteAmount })
