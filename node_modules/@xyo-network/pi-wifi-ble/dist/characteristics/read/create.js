...
exports.createReadCharacteristic = ({ uuid, name }, getCurrentValue, logger = debug_1.default('bleno:read')) => {
    const characteristic = new bleno_1.Characteristic(options_1.createReadOptions({ uuid, name }, (offset, callback) => __awaiter(this, void 0, void 0, function* () {
        try {
            logger(name, offset);
