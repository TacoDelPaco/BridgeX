...
class NetworkService extends bleno_1.PrimaryService {
    constructor(wifiManager, validatePin) {
        ...
        this.logger = debug_1.default('bleno:network');
        this.unsubscribe = () => null;
    }
    awaitScan() {
        return __awaiter(this, void 0, void 0, function* () {
            const networks = yield this.wifiManager.scan();
            const ssidList = lodash_1.uniq(lodash_1.map(networks, network => lodash_1.get(network, 'ssid')).filter(lodash_1.identity));
    ...
    start() {
        ...
        this.unsubscribe = lodash_1.over(unsubscribeFromStatus, unsubscribeFromConnect);
