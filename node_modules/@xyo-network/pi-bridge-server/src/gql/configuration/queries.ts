...
export const configurationQuery = () => ({
  ...
  tailUnattendedUpgrade: withAuth(async  (parent: any, args: any, { configuration }: IContext) => {
    return configuration.tailLog('/var/log/unattended-upgrades/unattended-upgrades-dpkg.log')
  }),

  getAptPackageVersion: async (parent: any, args: any, { configuration }: IContext) => {
    return configuration.getAptPackageVersion()
  },

  getNpmPackageVersion: async (parent: any, args: any, { configuration }: IContext) => {
