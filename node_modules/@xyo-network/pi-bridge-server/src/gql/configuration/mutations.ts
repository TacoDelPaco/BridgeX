...
export const configurationMutation = () => ({
  ...
  forceUpdate: withAuth(async (parent: any, args, { configuration }: IContext) => {
    return configuration.forceUpdate()
  }),

  lastResort: withAuth(async (parent: any, args, { configuration }: IContext) => {
    return configuration.lastResort()
  }),

  checkForUpdates: withAuth(async (parent: any, args, { configuration }: IContext) => {
    return configuration.checkForUpdates()
  }),

  factoryReset: withAuth(async (parent: any, args, { configuration }: IContext) => {
