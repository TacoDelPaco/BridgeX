...
function getOrCreateDb(dataFile) {
    const exists = fs_1.existsSync(dataFile);
    if (exists) {
        const fileContents = fs_1.readFileSync(dataFile, 'utf8');
    ...
    fs_1.writeFileSync(dataFile, base_1.XyoBase.stringify({}), 'utf8');
    return {};
}
function persist(dataFile, data) {
    ...
    fs_1.writeFileSync(dataFile, base_1.XyoBase.stringify(transform), 'utf8');
}
