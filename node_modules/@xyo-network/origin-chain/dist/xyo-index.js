...
class XyoIndexDeserializer {
    ...
    deserialize(data, serializationService) {
        ...
        return new XyoIndex((0, buffer_utils_1.readIntegerFromBuffer)(numberBuffer, numberBuffer.length, false, 0), numberBuffer);
    }
}
