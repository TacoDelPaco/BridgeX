...
function getSignerProvider(signerProviderType) {
    ...
    switch (signerProviderType) {
        case 'secp256k1-sha256':
            const sha256HashingProvider = hashing_1.getHashingProvider('sha256');
...
exports.XyoEcdsaSignature = xyo_ecdsa_signature_2.XyoEcdsaSignature;
var xyo_ecdsa_secp256k1_uncompressed_public_key_2 = require("./xyo-ecdsa-secp256k1-uncompressed-public-key");
exports.XyoEcdsaSecp256k1UnCompressedPublicKey = xyo_ecdsa_secp256k1_uncompressed_public_key_2.XyoEcdsaSecp256k1UnCompressedPublicKey;
...
exports.XyoEcdsaSecp256k1Signer = xyo_ecdsa_secp256k1_signer_2.XyoEcdsaSecp256k1Signer;
