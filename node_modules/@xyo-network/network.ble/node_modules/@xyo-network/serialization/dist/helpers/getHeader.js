...
function getHeader(byteLength, scheme, withoutSize = false) {
    const { numberToEncode, bytesRequired } = (() => {
        switch (scheme.sizeIdentifierSize) {
            ...
            case null:
                const numberOfBytesRequired = getLeastNumberOfBytesToEncodeSize_1.getLeastNumberOfBytesToEncodeSize(byteLength);
    ...
    const sizeBuffer = getSizeHeader_1.getSizeHeader(byteLength, bytesRequired);
    return Buffer.concat([
        byte0,
        byte1,
        sizeBuffer
