export class XyoInputStream {
    ...
    private nextWaitingSize: number | undefined = undefined
    private currentBuffer: Buffer | undefined = undefined
    ...
    private checkDone() {
        ...
        if (waitingSize && currentBuffer) {
            if (waitingSize <= currentBuffer.length) {
                const donePacket = currentBuffer.subarray(4, this.nextWaitingSize)
