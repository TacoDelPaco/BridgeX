...
class XyoClientBluetoothNetwork {
    ...
    findWithTimeout(timeoutInMills) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                // default no async
                yield this.scanner.startScan().then(() => __awaiter(this, void 0, void 0, function* () {
    ...
    find(_catalogue) {
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.onPipe = (pipe) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.shutDown(); // default no async/await
                resolve(pipe);
            });
            this.scanInterval = setInterval(this.scanLambda, 1000);
        }));
    ...
    stopServer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.scanner.stopScan(); // default no async/await
        });
    }
}
