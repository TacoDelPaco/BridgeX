...
exports.XyoAdvertisement = void 0;
class XyoAdvertisement {
    getMajor() {
        const randomBase = Math.floor(Math.random() * 65534);
        const randomBaseWithMask = randomBase & 130944;
        return randomBaseWithMask | this.advertisementId;
    }
    constructor(minor) {
        this.advertisementId = 0x03;
    ...
    getScanResponse() {
        ...
        return Buffer.from(uuid.toUpperCase(), "hex");
    }
}
exports.XyoAdvertisement = XyoAdvertisement;
//# sourceMappingURL=xyo-advertisement.js.map