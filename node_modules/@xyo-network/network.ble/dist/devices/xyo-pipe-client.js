...
class XyoPipeClient {
    ...
    chunkSend(data, characteristic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const action = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                const chunksToSend = xyo_output_stream_1.chunkBytes(this.addBleSize(data), 20);
