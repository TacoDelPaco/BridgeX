        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const promise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const services = this.device.discoverServicesForUuids(["d684352edf36484ebc982d5398c5593e"]);
                    if (services.length === 1) {
                        const characteristics = services[0].discoverCharacteristics();
