...
export class XyoClientTcpNetwork extends XyoBase implements IXyoNetworkProvider {
  ...
  private shouldStopPromise: (() => void) | undefined
  ...
  public stopServer(): Promise<void> {
    this.logInfo(`XyoClientTcpNetwork.stopServer()`)
    if (!this.isLooping) {
  ...
  private async getConnection(nextAddress: IXyoTCPNetworkAddress, _catalogue: IXyoNetworkProcedureCatalogue) {
