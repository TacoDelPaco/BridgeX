...
export class XyoServerTcpNetwork extends XyoBase implements IXyoNetworkProvider {
  ...
  public stopServer(): Promise<void> {
    this.logInfo(`XyoServerTcpNetwork.stopServer()`)
    if (this.server) {
  ...
  private getConnection(server: net.Server, _catalogue: IXyoNetworkProcedureCatalogue): Promise<XyoTcpConnectionResult> {
    ...
    return new Promise((resolve) => {
      const onConnection = (c: net.Socket) => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const onConnectionClose = (_hasError: boolean) => {
