...
class XyoTcpConnectionResult {
     ...
     */
    constructor(socket, initiationData) {
        this.socket = socket;
        this.initiationData = initiationData;
        this.socketId = Buffer.from(socket.remoteAddress || 'unknown');
    }
}
exports.XyoTcpConnectionResult = XyoTcpConnectionResult;
//# sourceMappingURL=xyo-tcp-connection-result.js.map