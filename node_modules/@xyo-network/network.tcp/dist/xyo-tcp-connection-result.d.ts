 ...
 */
export declare class XyoTcpConnectionResult {
    socket: net.Socket;
     ...
     */
    constructor(socket: net.Socket, initiationData: Buffer | undefined);
}
//# sourceMappingURL=xyo-tcp-connection-result.d.ts.map