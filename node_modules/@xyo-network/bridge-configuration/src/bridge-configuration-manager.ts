...
let mockPassword = ''
const mockPublicKey = '000c4114ab1adccbf3205ef2b524fe502fcdd2ee91ce3ea72898c6452cca510039e4ebfa3c7f133bfb415e1835337ecaed48195d576d5720c8cd729543a93e9e9b56ad'
...
const execAsync = (cmd: string): Promise<string> => {
  ...
  return new Promise((res, rej) => {
    exec(cmd, (e: Error | null, stdout: string, stderr: string) => {
      if (e) rej(e)
