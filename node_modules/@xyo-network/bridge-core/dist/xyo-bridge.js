...
class XyoBridge {
    constructor(bridgeFromNetwork, bridgeToNetwork, bridgeConfig) {
        this.bridgeFromNetwork = bridgeFromNetwork;
        this.bridgeToNetwork = bridgeToNetwork;
        ...
        this.networkDelegate = new peer_connections_1.XyoSimplePeerConnectionDelegate(this.bridgeFromNetwork, bridgeProcedureCatalogueCollect, this.networkHandler);
        this.toNetworkDelegate = new peer_connections_1.XyoSimplePeerConnectionDelegate(this.bridgeToNetwork, bridgeProcedureCatalogueSend, this.networkHandler);
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((yield this.bridgeConfig.chainRepo.getIndex()) === 0) {
                ...
                this.bridgeConfig.logger.info(`Creating first signer, has public key: ${newSigner.publicKey.getData().toString('hex')}`);
