...
import { CATALOGUE_LENGTH_IN_BYTES, CATALOGUE_SIZE_OF_SIZE_BYTES, CatalogueItem, IXyoNetworkPipe, IXyoNetworkProcedureCatalogue, IXyoNetworkProvider, bufferToCatalogueItems } from '@xyo-network/network'
